        ...
        public async Task<ActionResult<IEnumerable<tr_course_master>>> CourseMaster()
        {
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                using (var package = new ExcelPackage(new FileInfo(filePath)))
                {
                    ...
                    for (int row = 2; row <= rowCount; row++)
                    {
                        Console.WriteLine("1: " + worksheet.Cells[row, 1].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 1].Value == null ? "Y" : "N");
                        Console.WriteLine("2: " + worksheet.Cells[row, 2].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 2].Value == null ? "Y" : "N");
                        Console.WriteLine("3: " + worksheet.Cells[row, 3].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 3].Value == null ? "Y" : "N");
                        Console.WriteLine("4: " + worksheet.Cells[row, 4].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 4].Value == null ? "Y" : "N");
                        Console.WriteLine("5: " + worksheet.Cells[row, 5].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 5].Value == null ? "Y" : "N");
                        Console.WriteLine("6: " + worksheet.Cells[row, 6].Value);
                        Console.WriteLine(worksheet.Cells[row, 6].Value == null ? "Y" : "N");
                        Console.WriteLine("7: " + worksheet.Cells[row, 7].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 7].Value == null ? "Y" : "N");
                        Console.WriteLine("8: " + worksheet.Cells[row, 8].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 8].Value == null ? "Y" : "N");
                        Console.WriteLine("9: " + worksheet.Cells[row, 9].Value.ToString().Trim().Length);
                        Console.WriteLine(worksheet.Cells[row, 9].Value == null ? "Y" : "N");
